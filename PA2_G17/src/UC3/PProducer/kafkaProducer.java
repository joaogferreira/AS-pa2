...
public class kafkaProducer extends Thread {
    ...
    public kafkaProducer(String servers, 
            String ack, int retries, int maxInFlightRequestsPerConnection, 
            int batchSize, int lingerMs, String compressionType, int bufferMemory, int deliveryTimeoutMs,
            boolean enableAutoCommit, boolean allowAutoCreateTopics, String autoOffsetReset, int fetchMinBytes){
