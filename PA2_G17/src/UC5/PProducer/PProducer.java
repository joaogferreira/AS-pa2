        ...
        while( !received.equals("EOF") ){
            ...
            if(!received.equals("EOF")) {
                ...
                */
                ...
                switch(aux){
                    case "000001":
                        kafkaprod.sendData("Sensor", 0, "sensor" + numSensor, received); 
                        break;
                    case "000002":
                        kafkaprod.sendData("Sensor", 1, "sensor" + numSensor, received); 
                        break;
                    case "000003":
                        kafkaprod.sendData("Sensor", 2, "sensor" + numSensor, received); 
                        break;
                    case "000004":
                        kafkaprod.sendData("Sensor", 3, "sensor" + numSensor, received); 
                        break;
                    case "000005":
                        kafkaprod.sendData("Sensor", 4, "sensor" + numSensor, received); 
                        break;
                    case "000006":
                        kafkaprod.sendData("Sensor", 5, "sensor" + numSensor, received); 
                        break;
                }
