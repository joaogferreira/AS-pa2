...
./../../kafka_2.13-3.1.0/bin/kafka-topics.sh --create --bootstrap-server localhost:9092  --replication-factor 3 --partitions 1 --topic Sensor --config min.insync.replicas=2
