...
public class PConsumerGUI extends javax.swing.JFrame {
     ...
     * @param time
     */
    public PConsumerGUI(String id, int x, int y, long time) {
        initComponents();
    ...
    /**
     * Increment total of values recorded from sensors
     * @param sensorValue
     */
    public void incSum(float sensorValue ){
        this.rl.lock();
        try {
    ...
    public void setAverage(){
        this.rl.lock();
        try {
            float total = Float.parseFloat(this.jTextField5.getText());
            float count = Float.parseFloat(this.jTextField1.getText());
            
            float result = total / count;
            
            this.jTextField6.setText(String.valueOf(result));
        } finally {
            this.rl.unlock();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PConsumerGUI("", 1000, 10, 0L).setVisible(true);
        });
    }
